...
# Close modal logic update
def closeModal():
    try:
        # Wait for the modal to load and the close button to appear
        WebDriverWait(driver, 20).until(ec.visibility_of_element_located((By.CLASS_NAME, "btn-close")))
        ...
        if close_button.is_displayed() and close_button.is_enabled():
            ...
            print("Close button not visible or not clickable.")
...
def openModalGetDataCloseModalPerRow():
   ...
   # Click close modal button
    ...
    # Close the modal after data processing
    closeModal()
